  ...
  data() {
    return {
      ...
      customerListItems: [
        ...
        { title: "Rent Movie", icon: "mdi-account-plus", path: "/rent" },
        {
          title: "Withdraw Movie",
          icon: "mdi-calendar-clock",
          path: "/withdraw",
        },
        { title: "Favorite List", icon: "mdi-history", path: "/favorites" },
        {
          title: "Request Movie",
      ...
      employeeListItems: [
        ...
        { title: "Favorite List", icon: "mdi-history", path: "/favorites" },
        { title: "Movie Control", icon: "mdi-history", path: "/movie-control" },
        {
